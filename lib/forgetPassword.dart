...
var email;
  ...
  void CheckEmail(email) async {
    final response = await http.get("http://192.168.0.200/Vipin/AdminUser/index.php/Connector/forget_password?email=$email");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Forget Password ", style: TextStyle(color: Color(0XFFF92B7F)),
          // Color(0xFFF58524),
          // Color(0XFFF92B7F),
                  ...
                  child: Column(
                    children: <Widget>[
                      SizedBox(
                        width: 200,
                        height: 200,
                        child: Image.asset("images/forgot-password-icon.png"),
                      ),
                      SizedBox(
                        height: 20,
                      ),
